...
public class Trip implements Comparable<Trip> {
	...
	public double getEpm_totalcost() {
		return emp_totalcost;
	}

	public void setEpm_totalcost(double epm_totalcost) {
	...
	public String toString() {
		return "Emp Id = " + emp_id + ", Emp Name = " + emp_name + ", Emp Add = " + emp_address + ", Gas Price = " + emp_gasprice + ", Distance = " + emp_distance + ", Hotel Cost = " + emp_costhotel + ", Food Cost = " + emp_costfood + ", Total Cost = " + emp_totalcost;
	}
	...
	public void CalculateTotalCost() {
		emp_totalcost = Math.round(((emp_distance * emp_gasprice) + emp_costhotel + emp_costfood)*100.00)/100.00;
	}
}
