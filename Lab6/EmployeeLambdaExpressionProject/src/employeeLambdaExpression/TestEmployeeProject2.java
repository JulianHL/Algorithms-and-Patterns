package employeeLambdaExpression;
...
public class TestEmployeeProject2 {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		Map<Integer, List<Employee>> employeeHashMap = new LinkedHashMap<>();
		...
		while(inFile.hasNextLine()) {
			...
			List<Employee> employeeBonusList = new ArrayList<>();
		...
		employeeHashMap.forEach((key, list) -> System.out.println(list.get(0).toString()));
